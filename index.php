...
<div class="about" id="about">
	<div class="container">
		...
		<div class="w3-agileits-about-grids">
			<div class="col-md-4 agile-about-right">
...
?>
				<h3 class="w3l-sub">Offering the most competitive rates and fees</h3>
			...
			<div class="stats-info">
				<div class="col-md-4 col-xs-4 stats-grid slideanim">
					...
					<div class="agile-one">
						...
						<div class='numscroller numscroller-big-bottom' data-slno='1' data-min='0' data-max='15000' data-delay='.3' data-increment="1">15000</div>
					</div>
				</div>
				<div class="col-md-4 col-xs-4 stats-grid slideanim">
