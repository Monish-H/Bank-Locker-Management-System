...
<html lang="zxx">
<head>
<title>Bank Locker System | Home</title>
...
<td colspan="4" style="font-size:20px;color:blue">
 ...
 <tr>
    ...
    <th>View ID Proof</th>
    <td><a href="banker/addressproof/<?php echo $result['IDproof']?>" width="100" height="100" target="_blank"> <strong style="color: red">View</strong></a></td>
 </tr>
 <tr>
    <th>View Pic</th>
    <td><img src="banker/photo/<?php echo $result['Photo'];?>" width="100" height="100" value="<?php echo $result['Photo'];?>>"></td>
    <th>Status</th>
